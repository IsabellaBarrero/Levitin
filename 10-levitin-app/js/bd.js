 let modulos = [
    {
        ...
        temas: [
            {
                titulo: 'Introducción a la psicología musical',
                descripcion: 'A lo largo de la historia la música ha acompañado al ser humano, desde tiempos inmemorables los sonidos transmiten emociones y han sido una forma de expresión humana, lingüística y cultural. Durante años la música ha sido objeto de estudio, la humanidad ha explorado su relación con la mente y es ahí cuando aparece la psicología, la ciencia que estudia los procesos mentales.',
                video: '',
            },
...

    {
        ...
        temas: [
            {
                titulo: 'Percepción musical',
                descripcion: 'La percepción musical es la capacidad de interpretar y comprender la música a través de los sentidos, especialmente el oído. Esta área también implica la capacidad de reconocer patrones musicales, identifcar instrumentos y comprender el signifcado emocional y expresivo de la música. ',
                video: '',
            },
